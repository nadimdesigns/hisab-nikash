...
function BalanceCard({ net, income, expense }: { net: number; income: number; expense: number }) {
  ...
  return (
    <button
      ...
      className="shimmer-overlay relative w-full overflow-hidden rounded-[24px] bg-[linear-gradient(140deg,#022c22_0%,#0b5a3d_30%,#10b981_52%,#0a5c3c_74%,#022c22_100%)] p-5 text-left text-white shadow-[0_18px_40px_-12px_rgba(6,95,70,0.6)] transition-transform active:scale-[0.99] focus:outline-none focus-visible:ring-2 focus-visible:ring-ring"
    >
