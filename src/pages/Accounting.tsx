    ...
    <AppLayout title="হিসাব">
      <div className="mb-[10px] flex w-full flex-nowrap items-center gap-2">
        ...
        <Button
          ...
          className="flex-1 bg-gradient-to-r from-emerald-700 via-emerald-600 to-emerald-500 text-white hover:from-emerald-600 hover:via-emerald-500 hover:to-emerald-400"
        >
