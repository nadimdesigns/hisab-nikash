    ...
    <SidebarProvider>
      <div className="flex min-h-screen w-full bg-background">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <header className="sticky top-0 z-30 flex h-14 items-center gap-3 border-b border-sidebar-border bg-sidebar text-sidebar-foreground px-4 pt-[5px] shadow-sm md:pt-0">
            <div className="hidden md:block">
              <SidebarTrigger />
            </div>
